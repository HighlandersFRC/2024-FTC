...
import org.firstinspires.ftc.teamcode.Commands.OuttakeSpecify;
...
public class Specimen3 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        PathLoading pathLoading = new PathLoading(hardwareMap.appContext, "Autos/3S1.polarpath");
 ...
 /*       try {9[
        ...
        scheduler.schedule(new SequentialCommandGroup(scheduler,
                new ParallelCommandGroup(scheduler,Parameters.ALL,
                        ...
                        moveToPosition),
                new WristMove(Robot.wrist, 0.49 - Constants.WRIST_OFFSET),
                        move1,
                new ParallelCommandGroup(scheduler,Parameters.ALL,
                        new Pivot1(Robot.pivot,-16),
                        new IntakeAutoSpecimen(Robot.intake),
                        new WristMove(Robot.wrist,0.17),
                        move2),
                move3,
                ...
                new ParallelCommandGroup(scheduler,Parameters.ALL,
                        new IntakeAutoSpecimen(Robot.intake),
                        move5),
                new Elevator(Robot.elevators,-30),
                new ParallelCommandGroup(scheduler,Parameters.ALL,
                        new WristMove(Robot.wrist,1 - Constants.WRIST_OFFSET),
                        new Pivot3(Robot.pivot,Constants.ARM_HIGH),
                        move6
                        ),
                new WristMove(Robot.wrist,0.57),
                move7,
                new ParallelCommandGroup(scheduler,Parameters.ALL,
                        new Pivot1(Robot.pivot,-16),
                        new WristMove(Robot.wrist,0.17),
