    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (result != null && result.isValid()) {
                double tx = result.getTx();  // Get horizontal offset to AprilTag
                telemetry.addData("AprilTag tx (degrees)", tx);
                ...
                telemetry.addData("Limelight", "No AprilTag Targets");
            }
